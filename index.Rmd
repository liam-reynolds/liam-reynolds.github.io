...
```{r echo = FALSE}
  ...
  hor_gap_data %>% 
    ...
    labs(caption = "Source: Urban Institute Calculation of Census Bureau Data.\nNote: numbers through 2019 are from Census Bureau microdata. 2020 and 2021 numbers are from Census Bureau datatables, and racial category definitions\nare not perfectlyaligned between the two.") +
...
```{r echo = FALSE}
  ...
  hor_msa %>%
    ...
    xlab("Race") +
    ylab("Homeownership Rate") +
    labs(caption = "Source: Urban Institute calculations of Census Bureau Data.") +
    theme(axis.text.x = element_text(size= 20),
          axis.text.y = element_text(size = 20),
          legend.title = element_text(size = 20),
          legend.text = element_text(size = 20),
...
dist_household_home_wealth %>% 
  ...
  xlab("") +
  ylab("Share") +
  labs(caption = "Source: Urban Institute calculations of Census Bureau Data.") +           theme(axis.text.x = element_text(size= 20),
      axis.text.y = element_text(size = 20),
      legend.title = element_text(size = 20),
      legend.text = element_text(size = 20),
      plot.caption = element_text(hjust = 0))
...
```{r echo = FALSE}
  ...
  denial_national %>% 
    ...
    xlab("Race") +
    ylab("Denial Rate") +
    labs(caption = "Source: Urban Institute Calculation of 2021 HMDA Data.") +
    theme(axis.text.x = element_text(size= 20),
          axis.text.y = element_text(size = 20),
          legend.title = element_text(size = 20),
          legend.text = element_text(size = 20),
...
```{r echo = FALSE}
 ...
 wealth_gap %>% 
    ...
    xlab("Race") +
    ylab("Median Wealth") +
    labs(caption = "Source: 2019 Survey of Consumer Finances.") +
    theme(axis.text.x = element_text(size= 20),
          axis.text.y = element_text(size = 20),
          legend.title = element_text(size = 20),
          legend.text = element_text(size = 20),
...
```{r echo = FALSE}
  ...
  financial_health %>% 
    ...
    xlab("Race") +
    ylab("Median Wealth") +
    labs(caption = "Urban Institute Financial Health Dashboard.") +
    theme(axis.text.x = element_text(size= 20),
          axis.text.y = element_text(size = 20),
          legend.title = element_text(size = 20),
          legend.text = element_text(size = 20),
...
```{r echo = FALSE}
 ...
 national_burden %>%   
    ...
    labs(caption = "Source: Harvard Joint Center for Housing Studies.") +
    theme(axis.text.x = element_text(size= 20),
          axis.text.y = element_text(size = 20),
          legend.title = element_text(size = 20),
          legend.text = element_text(size = 20),
...
```{r echo = FALSE}
 ...
 burden %>%   
    filter(msa_name == "Atlanta-Sandy Springs-Alpharetta, GA Metro Area",
           geo_type == "msa") %>% 
    ggplot(aes(x = race, y = burden_share)) +
    geom_bar(position = "dodge", stat = "identity") +
    scale_fill_discrete(name = "", labels = c("Black", "White", "Total")) +
    scale_x_discrete(labels = c("Black", "White", "Total")) +
    scale_y_continuous(labels = scales::percent_format()) +
...
```{r echo = FALSE}
 parent_wealth %>% 
    ...
    ylab("Homeownership Rate") +
    labs(caption = "Source: Urban Institute calculations from Panel Study of Income Dynamics.") +
    theme(axis.text.x = element_text(size= 20),
          axis.text.y = element_text(size = 20),
          legend.title = element_text(size = 20),
          legend.text = element_text(size = 20),
...
```{r echo = FALSE}
  ...
  ltv_national %>% 
    ...
    labs(caption = "Urban Institute Calculations of 2021 HMDA data.") +
    theme(axis.text.x = element_text(size= 20),
          axis.text.y = element_text(size = 20),
          legend.title = element_text(size = 20),
          legend.text = element_text(size = 20),
...
```{r echo = FALSE}
  ...
  source %>% 
    ...
    xlab("Race") +
    ylab("Share of Homebuyers") +
    labs(caption = "Source: Urban Institute calculations from 2021 National Survey of Mortgage Originations Data.") +
    theme(axis.text.x = element_text(size= 20),
          axis.text.y = element_text(size = 20),
          legend.title = element_text(size = 20),
          legend.text = element_text(size = 20),
